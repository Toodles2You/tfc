...
{
public:
	CFuncArea(Entity* containingEntity) : CBaseEntity(containingEntity) {}
...
bool CFuncArea::Spawn()
{
	...
	if (streq("func_ladder", classname))
	{
		v.skin = CONTENTS_LADDER;
	}
	else if (streq("func_nogrenades", classname))
	{
